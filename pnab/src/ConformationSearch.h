...
namespace PNAB {
    ...
    public:
        ...
        std::string GeneticAlgorithmSearch();
        std::vector <std::piecewise_linear_distribution<double>> WeightedDistributions(std::vector<OpenBabel::OBRotor*> &rotor_vector, OpenBabel::OBMol &bu_a_mol);
